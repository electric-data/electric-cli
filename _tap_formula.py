"""Dynamically generate the contents of the `electric-data/tap/electric-cli` brew formula."""
...
def render():
    context = {
        'version': version,
        'url': download_url('electric-data-cli', version),
        'hash': sha_hash(f'dist/electric-data-cli-{version}.tar.gz'),
        'resources': []
    }
